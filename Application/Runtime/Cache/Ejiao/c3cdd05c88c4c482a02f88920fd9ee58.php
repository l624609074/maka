...
<link href="/maka/Public/Ejiao/images/css/1.css" rel="stylesheet" type="text/css" />
...
<div class="box">
	...
	<div class="navigation">
		<a title="阿胶历史" href="#ejls"><img src="/maka/Public/Ejiao/images/ejls.jpg" style="width:110px; height:99px; float:left;" /></a> 
		<a title="血气测试" href="#xqcs"><img src="/maka/Public/Ejiao/images/qxcs.jpg" style="width:110px; height:99px; float:left;" /></a>
		<a title="阿胶含片" href="#ejhp"><img src="/maka/Public/Ejiao/images/ejhp.jpg" style="width:110px; height:99px; float:left;" /></a>
		<a title="功效和作用" href="#gxyzy"><img src="/maka/Public/Ejiao/images/gxzy.jpg" style="width:113px; height:99px; float:left;" /></a>
		<a title="专家评说" href="#zjps"><img src="/maka/Public/Ejiao/images/zjps.jpg" style="width:110px; height:99px; float:left;" /></a>
		<a title="适用人群" href="#syrq"><img src="/maka/Public/Ejiao/images/syrq.jpg" style="width:110px; height:99px; float:left;" /></a>
		<a title="消费者评论" href="#xfzpl"><img src="/maka/Public/Ejiao/images/xfzpl.jpg" style="width:113px; height:99px; float:left;" /></a>
		<a title="在线订购" href="#zxdg"><img src="/maka/Public/Ejiao/images/zxdg.jpg" style="width:113px; height:99px; float:left;" /></a>
		<a title="我们的承诺" href="#wmdcn"><img src="/maka/Public/Ejiao/images/wmdcn.jpg" style="width:111px; height:99px; float:left;" /></a>
	</div>
	<div class="p2"></div>
	<div class="p3">
			<div class="ejls" id="ejls" name="ejls">
			<div class="titlebar">
			<img src="/maka/Public/Ejiao/images/p3.jpg" />
			</div>
			</div>
	...
	var ws="";
	  ...
	  {		  
		  ws=ws+e;
		  document.getElementById('zhuan_qxcs').value=ws;
		  }
    </script>
    <script type="text/javascript">
      function myCheck2()
      {
		var zhan_name = document.getElementById('zhan_name').value;
		var nianl = document.getElementById('nianl').value;
		var zhua_shou = document.getElementById('zhua_shou').value;
		var dia=/^[0-9-]{6,13}$/;
		if(zhan_name==""){
			alert("姓名不允许为空");
			return false;
			...
			alert("电话号码不允许为空");
			return false;
		}else if(dia.test(zhua_shou)==false){
			alert("电话号码格式不对");
			return false;
		}else if(nianl==""){
			alert("年龄不允许为空");
	...
	<div class="p4">
		<div class="xqcs" id="xqcs" name="xqcs">
			<div class="titlebar">
				<div class="right">
                <form method="post" id="form2" action="{:iurl('post,setok',"id=$id&module_id=42")}" onsubmit="return to_submit();"  style="width:370px; height:616px; margin-top:260px;">                
                    ...
                    <input name="zhuan_qxcs" id="zhuan_qxcs" type="text" style="display:none;" />
					
					<input name="zhan_name" id="zhan_name" type="text" style="width:166px; height:23px; margin-left:78px; margin-top:115px; background:none; border:0px; padding:0px;" />
					<input name="nianl" id="nianl" type="text" style="width:166px; height:23px; margin-left:78px; margin-top:14px; background:none; border:0px; padding:0px;" />
					<input name="zhua_shou" id="zhua_shou" type="text" style="width:166px; height:23px; margin-left:78px; margin-top:15px; background:none; border:0px; padding:0px;"/>
	...
	<div class="p5">
			...
			<div class="titlebar">
			<img src="/maka/Public/Ejiao/images/p5.jpg" />
			</div>
			</div>
	</div>
	<div class="p6">
		<div class="gxyzy" id="gxyzy" name="gxyzy">
			<div class="titlebar">
			<img src="/maka/Public/Ejiao/images/p6.jpg" />
			</div>
			</div>
	</div>
	<div class="p7">
	...
	<div class="p9">
			...
			<div class="titlebar">
			<img src="/maka/Public/Ejiao/images/p9.jpg" />
			</div>
			</div>
	</div>
	<div class="p10">
			...
			<div class="titlebar">
			<img src="/maka/Public/Ejiao/images/p10.jpg" />
			</div>
			</div>
	</div>
	<div class="p11">
			...
			<div class="titlebar">
				<a title="货到付款" href="#hdfk"><img src="/maka/Public/Ejiao/images/button.png"  style="position:relative; top:159px; left:-78px;" /></a>
				<a title="货到付款" href="#hdfk"><img src="/maka/Public/Ejiao/images/button.png" style="position:relative; top:159px; left:75px;"  /></a>
				<br />

				<a title="货到付款" href="#hdfk"><img src="/maka/Public/Ejiao/images/button.png" style="position:relative; top:24px; left:-81px;" /></a>
				<a title="货到付款" href="#hdfk"><img src="/maka/Public/Ejiao/images/button.png" style="position:relative; top:24px; left:71px; "/></a>
			</div>
			</div>
	</div>
	<div class="p12">
	...
	<div class="hdfk" id="hdfk" name="hdfk">
			<div class="titlebar">
		<div class="left">
		<form method="post"  name="form1" id="form1" action="/maka/index.php/Ejiao/SubOrder/submit" onsubmit="return to_submit();" style="width:247px; height:446px; margin-left:203px; margin-top:205px;">
            <label>
