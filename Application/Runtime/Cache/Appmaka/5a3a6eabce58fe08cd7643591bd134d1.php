...
<title>玛卡</title>
<script src="/maka/Public/Appmaka/js/jq.js"></script>
<link href="/maka/Public/Appmaka/css/style.css" rel="stylesheet" type="text/css">
</head>
<script>

function phpsys_update_code(a){
	a.src="/maka/index.php/Appmaka/Verify/getVerifyCode?"+Math.random();
}
...
<div class="bg">
  ...
  <div class="maka10" id="maka10">
    ...
    <div class="maka10_t">
      <form method="POST" action="/maka/index.php/Appmaka/SubOrder/submit" onsubmit="return mycheck()" name="form1" id="form1" >
        ...
        <div class="line_div"> <span class="text">付款方式</span>
          ...
          <div class="input_div">
           <input type="text" name="verify" /> <img src="/maka/index.php/Appmaka/Verify/getVerifyCode"  style=" margin-left:2%; width:100px;" border="0" align="absmiddle" style="cursor:pointer;"  onclick="phpsys_update_code(this)" id="codeImg" > 
          </div>
          <div class="both"></div>
        </div>
