        ...
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li class="active"><a href="content.html" class="icon-shopping-cart" class="icon-file-text" > 订单管理</a>
					<ul><li><a href="#"> </a></li><li class="active"><a href="/web/index.php/Admin99/User">订单管理</a><li><a href="/web/index.php/Admin99/Order/Search">订单搜索</a></li><li><a href="/web/index.php/Admin99/Product/All">产品设定</a></li><li><a href="/web/index.php/Admin99/Advisory/Index">美容测试</a></li></ul>
                </li>
...
<br/>
<br/>
<input type="button" value="提交" onclick="orderAction('sent','','/web/index.php/Admin99/Order')" />
</center>
...
<div class="admin">
    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            ...
            <input type="button" class="button button-small border-yellow" value="添加新订单" onclick="window.location.href='/web/index.php/Admin99/Order/Add'" />
			...
			<th width="10%">订单号</th><th width="120">产品名字*盒数--总价格</th><th width="30">客户名</th><th width="100">联系电话</th><th width="100">联系地址</th><th width="20">付款方式</th><th width="100">用户留言</th><th width="20">下单时间</th><th width="60">订单状态</th><th>客户端</th><th width="100">快递公司--单号</th><th width="100">操作</th><th>客服</th></tr>
				...
				<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>	
						...
						<td><?php echo ($vo["orderid"]); ?></td><td><?php echo ($vo["productname"]); ?>--<?php echo ($vo["price"]); ?></td><td><?php echo ($vo["name"]); ?></td><td><?php echo ($vo["contact"]); ?></td><td><?php echo ($vo["address"]); ?></td><td><?php echo ($vo["payment"]); ?></td><td>
							...
							<?php if(strlen($vo['word']) > 30 ): echo (substr($vo["word"],0,30)); ?><a href="/web/index.php/Admin99/Order/Modify/orderid/<?php echo ($vo["orderid"]); ?>" ><font color="red">...查看更多</font></a>
							<?php else: ?> 
				...
				<td><?php echo ($vo["expressname"]); ?>--<?php echo ($vo["expressnum"]); ?></td>		
						<td>
							<a class="button border-blue button-little" href="#" onclick="orderAction('Confirm','<?php echo ($vo["orderid"]); ?>','/web/index.php/Admin99/Order')" >确认</a> 
							<a class="button border-green button-little" href="#" onclick="showBg('<?php echo ($vo["orderid"]); ?>')" >发货</a>
							<a class="button border-yellow button-little" href="/web/index.php/Admin99/Order/Modify/orderid/<?php echo ($vo["orderid"]); ?>"  onclick="" >修改</a>
							<a class="button border-red button-little" href="javascript:orderAction('Delete','<?php echo ($vo["orderid"]); ?>','/web/index.php/Admin99/Order')" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
