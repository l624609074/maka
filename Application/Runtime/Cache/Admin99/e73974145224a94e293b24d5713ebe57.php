    ...
    <div class="mainer">
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li class="active"><a href="/web/index.php/Admin99/User/index/System/<?php echo ($System); ?>" class="icon-shopping-cart" class="icon-file-text" > 订单管理</a>
					<ul><li><a href="#"> </a></li><li class="active"><a href="/web/index.php/Admin99/User/index/System/<?php echo ($System); ?>">订单管理</a><li><a href="/web/index.php/Admin99/Order/Search/System/<?php echo ($System); ?>" >订单搜索</a></li><li><a href="/web/index.php/Admin99/Product/All/System/<?php echo ($System); ?>" >产品设定</a></li><li><a href="/web/index.php/Admin99/Advisory/Index/System/<?php echo ($System); ?>" >美容测试</a></li></ul>
                </li>
        ...
        <table class="table table-hover" border=1 style="text-align:center">
			...
			<th width="10%">订单号</th><th width="120">产品名字*盒数--总价格</th><th width="30">客户名</th><th width="100">联系电话</th><th width="100">联系地址</th><th width="20">付款方式</th><th width="100">用户留言</th><th width="20">下单时间</th><th width="60">订单状态</th><th width="100">快递公司--单号</th><th width="100">操作</th></tr>
				...
				<td><?php echo ($vo["expressname"]); ?>--<?php echo ($vo["expressnum"]); ?></td>		
						<td>
							<a class="button border-blue button-little" href="#" onClick="orderAction('Confirm','<?php echo ($vo["orderid"]); ?>','/web/index.php/Admin99/Order','<?php echo ($System); ?>')" >确认</a> <a class="button border-green button-little" href="#" onClick="showBg('<?php echo ($vo["orderid"]); ?>')" >发货</a>
