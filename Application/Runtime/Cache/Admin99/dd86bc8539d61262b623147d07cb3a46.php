...
<div class="admin">
	...
	<center>
		...
		<form action="/maka/index.php/Admin99/Product/DoModify">
				  <table class="table table-hover" border=1 style="text-align:center">
		<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr><td>产品名字</td><td><input type="text" name="ProductName" value="<?php echo ($vo["productname"]); ?>" style="width:400px"/></td></tr>
			
				<tr>	
				<td>产品价格</td><td>¥ <input type="text"  value="<?php echo ($vo["price"]); ?>" name="Price" /></td>	
				<input type="hidden"  value="<?php echo ($vo["id"]); ?>" name="id"  />
				</tr><?php endforeach; endif; ?>
	
			<tr  ><td colspan=2><br/><input type="submit" value="确认修改" /></td></tr>
