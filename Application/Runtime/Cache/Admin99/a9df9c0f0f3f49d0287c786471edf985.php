...
<link rel="stylesheet" type="text/css" href="/maka/Public/css/login/css/style.css" />
<script type="text/javascript" src="/maka/Public/js/jq.js"></script>
</head>
<script>
$(function(){
		$("#verifyImg").on("click",function(){
				$(this).attr("src","/maka/index.php/Admin99/Verify/getVerifyCode?"+Math.random()+"");
...
<div class="box">
	<div class="head">
		<img src="/maka/Public/css/login/images/logo.png" style="margin:0 auto; line-height:192px;" />
	...
	<div class="mid">
		<form id="form1" name="form1" method="post" action="/maka/index.php/Admin99/User/login" style="width:266px; height:335px;">
		  <label>
			...
			<br />
			<input type="submit" style="background:none; text-indent:99999px; margin-top:28px; border:0; width:266px; height:34px; cursor:pointer;position:relative;top:-22px" />
		  </label>
        </form>
	  </div>
</div>
