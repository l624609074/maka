	...
	<center>
	   	<div class="panel-head"><strong>产品信息列表</strong></div>
			...
			<td><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" /></td><td><?php echo ($vo["id"]); ?></td><td><?php echo ($vo["productname"]); ?></td><td>¥ <?php echo ($vo["price"]); ?></td>		<td>
							...
							<a class="button border-red button-little" href="javascript:window.location.href='/web/index.php/Admin99/Product/Delete/id/<?php echo ($vo["id"]); ?>'" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
